...
- [ ] 1. Set up core interfaces and type definitions
  ...
  - [ ] 1.2 Create IExternalVault interface
  ...
  - [ ] 1.3 Define core data structures
...
- [ ] 2. Implement base contract structure and access control
  - [ ] 2.1 Create YieldSubsidizedDirectionalHook contract skeleton
  ...
  - [ ] 2.2 Implement access control modifiers and ownership
...
- [ ] 3. Implement hook permissions and pool registration
  - [ ] 3.1 Implement getHookPermissions function
  ...
  - [ ] 3.2 Implement beforeInitialize callback
  ...
  - [ ]* 3.3 Write unit tests for pool registration
